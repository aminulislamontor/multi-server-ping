...
<head>
    ...
    <?php if (LG_CSS_OVERRIDES) {
        echo '<link href="' . LG_CSS_OVERRIDES . '" rel="stylesheet">';
    } ?>
</head>
                                ...
                                <div class="row">
                                    <div class="col-md-7 mb-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="IP address or host..." name="targetHost" value="<?php if (isset($_SESSION['TARGET'])) {
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="backendMethod" id="backendMethod">
                                                <?php foreach (LG_METHODS as $method) { ?>
                                                    <option value="<?php echo $method; ?>" <?php if (isset($_SESSION['METHOD']) && $_SESSION['METHOD'] == $method) {
                                                                                                echo 'selected';
                                ...
                                <div class="d-flex align-items-center">
                                    <?php if (LG_TERMS) { ?>
                                        <div class="form-check">
                                            <input type="checkbox" id="checkTerms" name="checkTerms" class="form-check-input" <?php if (isset($_SESSION['TERMS'])) {
                                                                                                                                    echo 'checked';
                                                                                                                                } ?>>
    ...
    <script type="text/javascript">
        ...
        function callBackend() {
            ...
            xhr.onreadystatechange = function() {
                ...
                // I store the ping result in "pingvalue"
                var pingvalue = this.responseText
                document.cookie = "data = " + pingvalue;
                <?php
                $name = $_COOKIE['data'];
                echo $name;
                ?>
